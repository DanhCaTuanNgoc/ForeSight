...
import { Radio, TrendingUp, TrendingDown, AlertCircle, ArrowUpRight } from "lucide-react";
  ...
  return (
    <div className="bg-[#08080E] border border-white/[0.07] rounded-none p-3.5 h-full flex flex-col font-mono">
      ...
      <div className="space-y-2 overflow-y-auto max-h-[520px] pr-0.5 flex-1 custom-scrollbar">
        {signals.length === 0 ? (
          <div className="text-center py-16 text-gray-400 text-xs flex flex-col items-center justify-center space-y-2 font-mono">
            <div className="w-5 h-5 rounded-none border border-violet-500/40 border-t-violet-400 animate-spin" />
            <div>
